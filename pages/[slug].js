  ...
  return {
    props: {
      smartlink: {
        ...
        url_deezer: smartlink.url_deezer,
        url_tidal: smartlink.url_tidal,
        url_soundcloud: smartlink.url_soundcloud,
        url_pandora: smartlink.url_pandora,
        url_iheartradio: smartlink.url_iheartradio,
        url_whatsapp: smartlink.url_whatsapp,
        community_url: smartlink.community_url,
        community_label: smartlink.community_label,
        preview_url: smartlink.preview_url,
        preview_source: smartlink.preview_source,
      },
