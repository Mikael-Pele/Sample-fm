...
const CONSENT_KEY = "droppafm_consent_marketing";
    ...
    <div className="min-h-screen bg-base-bg text-white">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <p className="text-sm text-base-muted mb-10">
          Control what Droppa.fm is allowed to use on your device.
        </p>
          ...
          <div className="glass-card rounded-xl2 p-5 flex items-start justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="text-sm text-base-muted">
                Keeps you signed in and remembers your session. Required for Droppa.fm to
