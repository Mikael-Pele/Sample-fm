  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" width={size} height={size} fill="none">
        ...
        {/* Anchor hook — a shank dropping down into a hook curling right,
            with the hook's "eye" ring at top. Reads at 16px in a header
            and scales cleanly up for the homepage / marks. */}
        <circle cx="9.5" cy="6.5" r="1.5" stroke="#0A0A0C" strokeWidth="1.6" fill="none" />
        <path
          d="M9.5 8.3V14a4 4 0 0 0 4 4h3.2"
          stroke="#0A0A0C"
          strokeWidth="1.8"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export function PlaySnippetIcon({ className, size = 22 }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={className} fill="none">
...
export function PauseSnippetIcon({ className, size = 22 }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={className} fill="none">
